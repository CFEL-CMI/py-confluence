...
class confluence_create_CMI_space(object):
	"""docstring for confluence_create_CMI_space"""
	def __init__(self, arg):
		super(confluence_create_CMI_space, self).__init__()
		self.arg = arg
		...
		srv.confluence2.updatePage(token, homepage,{"versionComment": "updated Page accoring to template"})
